...
backgroundGradient.addColorStop(1, '#c2a0d9')
...
function animate() {
    ...
    if(flag) creatMountainRange(1, canvas.height * 0.7, '#a84141')
    if(flag) creatMountainRange(2, canvas.height * 0.6, '#c75656')
    if(flag) creatMountainRange(3, canvas.height * 0.4, '#bf3030')
    c.fillStyle = '#182028'
